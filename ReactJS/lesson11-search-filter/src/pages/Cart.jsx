                    ...
                    <table className="table">
                        ...
                        <tbody>
                            {items.map(item => (
                                <tr>
                                    <th scope="row">1</th>
                                    <td><Link to={`/products/${slugify(item.title)}`}><img width={100} src={item.images[0]} alt={item.title} /></Link></td>
                                    <td><Link to={`/products/${slugify(item.title)}`}>{item.title}</Link></td>
